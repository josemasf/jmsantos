...
export const author = {
  ...
  url: `${site}/about/`,
  sameAs: ["https://www.linkedin.com/in/jos%C3%A9-mar%C3%ADa-santos-90a8a73a/", "https://github.com/josemasf"],
};
...
export function articleSchema(
  ...
  return {
    ...
    author,
    publisher: { "@type": "Person", name: "José María Santos", url: `${site}/about/` },
